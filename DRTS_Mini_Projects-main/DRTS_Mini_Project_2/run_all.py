...
def main():
    ...
    # Starvation demonstration (Test Case 4)
    print("\n" + "="*72)
    print(" PHASE 4: Starvation Prevention Demonstration (Test Case 4)")
    print("="*72)
    total_count += 1
    if run_command(
        "python results/generate_starvation_demo.py",
        "Starvation demo — CBS vs SP under 95% Class A load",
    ):
        success_count += 1
    ...
    print("="*72)
    total_count += 1
    if run_command("python results/generate_plots.py", "Generate visualization charts (9 total)"):
        success_count += 1
